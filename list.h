...
PLIST add_value(Array x,PLIST lst); // acrescenta nó com x; retorna nova lista
PLIST del_value(Array x,PLIST lst); // remove primeiro nó com x; retorna nova lista
PLIST del_node(PLIST rno,PLIST lst); // remove nó rno; retorna nova lista
bool member(Array x,PLIST lst);    // verifica se x está na lista
